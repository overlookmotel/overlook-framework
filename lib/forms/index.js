...
var forms = module.exports = {
	...
	getFormatFromModelField: function(fieldParams) {
		...
		if (type instanceof Sequelize.BOOLEAN) {
			...
			field = {format: 'text', length: 65535};
		} else if (type instanceof Sequelize.TINYTEXT) {
			field = {format: 'text', length: 255};
		} else if (type instanceof Sequelize.MIDDLETEXT) {
			field = {format: 'text', length: 16777215};
		} else if (type instanceof Sequelize.LONGTEXT) {
			field = {format: 'text', length: 4294967295};
