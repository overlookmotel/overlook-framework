...
exports = module.exports = {
	login: function(login, password, remember, res, overlook) {
		return loginCheck(login, password, overlook)
		.then(function(user) {
			if (!user) return;
...
function loginCheck(login, password, overlook) {
	return overlook.models.user.find({where: {login: login, isActive: true}, attributes: ['id', 'name', 'passwordHash', 'cookieKey']})
	.then(function(user) {
