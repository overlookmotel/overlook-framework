...
module.exports = {
    ...
    init: function(overlook) {
        // get default options for workers
        var defaultOptions = overlook.options.workers._default || {};
        ...
        _.forIn(workers, function(workerDef, workerName) {
            ...
            // get worker's config
            var options = _.defaults(overlook.options.workers[workerName] || {}, defaultOptions);
            ThisWorker.options = options;
    ...
    startup: function(overlook) {
        return Promise.inSeries(overlook.workers, function(worker) {
            ...
            var apiParams = (currentJob.startParams ? currentJob.startParams() : {});
...
_.extend(Job.prototype, {
    ...
    get: function() {
        ...
        var params = (this.startParams ? this.startParams() : {});
        params = _.extend({
    ...
    start: function() {
        ...
        var options = {
            progressFn: function(state) {
                return self.progressed(state);
            },
            progressInterval: this.Worker.options.progressInterval
        };
        ...
        .catch(function(err) {
            // job failed
            this.log('Failed', {message: err.message, stack: err.stack});
        ...
        .then(function() {
            ...
            if (this.onSuccess) {
                ...
                .catch(function(err) {
                    ...
                    var error = new Error('Error cleaning up after success');
                    error.parent = err;
                    error.result = result;
                    throw error;
                });
