...
function combineFunctions(fn, defaultFn) {
	var defaultFnAsync = Promise.method(defaultFn);

	var newFn = function(defaultFn2) {
		var self = this;

		var calledWithFn = function() {
			var args = Array.prototype.slice.call(arguments);
			args.unshift(defaultFn2);
			return defaultFnAsync.apply(self, args);
		};
		calledWithFn.defaultFn = defaultFn.defaultFn && Promise.method(defaultFn.defaultFn);

		var args = Array.prototype.slice.call(arguments);
		args.unshift(calledWithFn);
		return fn.apply(this, args);
	};

	newFn.fn = fn;
	newFn.defaultFn = defaultFn;
